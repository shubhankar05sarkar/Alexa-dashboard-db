  ...
  return (
    <div className="min-h-screen bg-black relative">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center min-h-screen px-4 gap-6 relative z-10">
        ...
        {/* AlexaVerse 2.0 - Disabled Card */}
        <div className="w-full sm:w-auto cursor-not-allowed">
          <div className="bg-white/5 backdrop-blur-md p-8 rounded-xl shadow-2xl border border-white/10 w-full max-w-md sm:max-w-sm xs:max-w-xs opacity-50">
            <h1 className="text-4xl sm:text-3xl xs:text-2xl font-bold text-gray-400 mb-2 text-center">
              AlexaVerse 2.0
            </h1>
          </div>
        </div>

        {/* Recruitments 2025 - Disabled Card */}
        <div className="w-full sm:w-auto cursor-not-allowed">
          <div className="bg-white/5 backdrop-blur-md p-8 rounded-xl shadow-2xl border border-white/10 w-full max-w-md sm:max-w-sm xs:max-w-xs opacity-50">
            <h1 className="text-4xl sm:text-3xl xs:text-2xl font-bold text-gray-400 mb-2 text-center">
              Recruitments 2025
