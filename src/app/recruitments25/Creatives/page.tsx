                ...
                <div className="hidden md:flex gap-4">
                  <div className="relative">
                    <select
                      ...
                      className="bg-gray-800/50 border border-pink-500/30 rounded-lg py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-pink-500 appearance-none pr-8"
                    >
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="bg-gray-800/50 border border-pink-500/30 rounded-lg py-2 px-4 pl-10 text-white focus:outline-none focus:ring-2 focus:ring-pink-500"
                      value={searchTerm}
              ...
              {showMobileSearch && (
                <div className="mb-4">
                  <input
                    type="text"
                    placeholder="Search participants..."
                    className="w-full bg-gray-800/50 border border-pink-500/30 rounded-lg py-2 px-4 text-white focus:outline-none focus:ring-2 focus:ring-pink-500"
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                  />
                </div>
